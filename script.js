...
(function() {
    const imageMap = {
        'Malteada de Cerveza': 'images/Sugar/bebidas/IMG-20260328-WA0025.jpg',
        'Malteada': 'images/Sugar/malteadas/IMG-20260328-WA0026.jpg',
        'Milo Frappe': 'images/Sugar/cafe/IMG-20260328-WA0071.jpg',
        'Frappuccino': 'images/Sugar/bebidas/IMG-20260328-WA0028.jpg',
        'Jugos Naturales': 'images/Sugar/bebidas/IMG-20260328-WA0029.jpg',
        'Limonada Tropical': 'images/Sugar/bebidas/IMG-20260328-WA0030.jpg',
        'Sodas Italianas': 'images/Sugar/bebidas/IMG-20260328-WA0031.jpg',
        'Batidos': 'images/Sugar/malteadas/IMG-20260328-WA0032.jpg',
        'Batidos Saludables': 'images/Sugar/malteadas/IMG-20260328-WA0033.jpg',
        'Affogato Sugar': 'images/Sugar/bebidas/IMG-20260328-WA0034.jpg',
        'Affogato': 'images/Sugar/bebidas/IMG-20260328-WA0035.jpg',
        'Cappuccino': 'images/Sugar/cafe/IMG-20260328-WA0036.jpg',
        'Café Espresso': 'images/Sugar/cafe/IMG-20260328-WA0037.jpg',
        'Aromática': 'images/Sugar/bebidas/IMG-20260328-WA0038.jpg',
        'Té': 'images/Sugar/bebidas/IMG-20260328-WA0039.jpg',
        'Té Chai': 'images/Sugar/bebidas/IMG-20260328-WA0040.jpg',
        'Arcoíris': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0041.jpg',
        'Atardecer': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0042.jpg',
        'Servicio de Michelada': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0043.jpg',
        'Piña Colada': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0044.jpg',
        'Margarita Tradicional': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0045.jpg',
        'Margarita Cerezada o Mango': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0046.jpg',
        'Mojito': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0047.jpg',
        'Mojito de Fresa': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0048.jpg',
        'Hechizo Sugar': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0049.jpg',
        'Órgasmo': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0050.jpg',
        'Cerveza de Colores': 'images/Sugar/micheladas,cocteles,batidos/IMG-20260328-WA0051.jpg',
        'Torta Chocolate Premium': 'images/Sugar/tortas/IMG-20260328-WA0052.jpg',
        'Torta Fresas Encantada': 'images/Sugar/tortas/IMG-20260328-WA0053.jpg',
        'Torta Tres Leches Sugar': 'images/Sugar/tortas/IMG-20260328-WA0054.jpg',
        'Torta Zanahoria Gourmet': 'images/Sugar/tortas/IMG-20260328-WA0055.jpg',
        'Cheesecake New York': 'images/Sugar/tortas/IMG-20260328-WA0056.jpg',
        'Torta Red Velvet': 'images/Sugar/tortas/IMG-20260328-WA0057.jpg',
        'Torta Piña Colada': 'images/Sugar/tortas/IMG-20260328-WA0058.jpg',
        'Torta Oreo Deluxe': 'images/Sugar/tortas/IMG-20260328-WA0059.jpg',
        'Torta Lúcuma Premium': 'images/Sugar/tortas/IMG-20260328-WA0060.jpg',
        'Torta Frutos Rojos': 'images/Sugar/tortas/IMG-20260328-WA0061.jpg',
        'Lasaña Clásica': 'images/Sugar/lasañas/IMG-20260328-WA0050.jpg',
        'Sanduche Italiano': 'images/Sugar/sanduches/IMG-20260328-WA0063.jpg',
        'Cupcake Vainilla': 'images/Sugar/cupcakes/IMG-20260328-WA0064.jpg',
        'Brownie con Helado': 'images/Sugar/postres/IMG-20260328-WA0065.jpg',
    ...
    const categoryPaths = [
        ...
        'images/Sugar/malteadas',
        'images/Sugar/cafe',
        'images/Sugar/micheladas,cocteles,batidos',
        'images/Sugar/tortas',
        'images/Sugar/cupcakes',
        'images/Sugar/postres',
        'images/Sugar/lasañas',
        'images/Sugar/sanduches'
    ];

    for (let n = 25; n <= 90; n++) {
        const num = n.toString().padStart(4, '0');
        categoryPaths.forEach(folder => {
            sugarImagePaths.push(`${folder}/IMG-20260328-WA${num}.jpg`);
        });
        sugarImagePaths.push(`images/Sugar/IMG-20260328-WA${num}.jpg`); // fallback raíz
    }
    ...
    productosCards.forEach((producto, index) => {
        ...
        const candidateUrls = [
            ...
            imageMap[titulo],
            sugarImagePaths[index % sugarImagePaths.length],
            `images/Sugar/IMG-20260328-WA${String(25 + index).padStart(4, '0')}.jpg`,
            'images/tortas.jpeg'
        ].filter(Boolean);
        ...
        imgElement.src = candidateUrls[currentCandidate];
        imgElement.onerror = function() {
            currentCandidate++;
            if (currentCandidate < candidateUrls.length) {
                this.src = candidateUrls[currentCandidate];
            } else {
                this.onerror = null;
                this.src = 'images/tortas.jpeg';
            }
        };
